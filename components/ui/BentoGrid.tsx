...
export const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid md:auto-rows-[18rem] grid-cols-1 md:grid-cols-3 gap-7 max-w-7xl mx-auto relative mb-10",
        className
      )}
    >
      {children}
...
export const BentoGridItem = ({
  ...
  return (
    ...
    >
      {header}
      <div className="group-hover/bento:translate-x-2 transition duration-200 z-10" style={{ whiteSpace: "pre-wrap" }}>
        {icon}
